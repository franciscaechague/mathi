...
$recipients = 'mathias@clica.com.ar';
...
try {
    ...
    $subject = $_POST['firstname'] . " - Servicio Tecnico";
	...
	$mail->Port = 465;
	$mail->SMTPAuth = true;
	$mail->Username = 'mathias@clica.com.ar'; // SMTP username
	$mail->Password = 'umf365626'; // SMTP password*/
    $mail->CharSet = 'utf-8';
